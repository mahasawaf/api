...
//.........................................searchhhhhhh..............................................
var searchRes=[]
// function searchMovee(searchTerm){
...
//         // let found = resultss[i].name.find(searchTerm => searchTerm  = searchInput.value);
//         // console.log(found)

//         if(resultss[i].name.includes(searchTerm)){
//             console.log('hello')
//             searchRes.push(resultss[i]);

            
//         }
//     displayData(searchRes)
...
//         if (resultss[i].nameInpot.includes(term) == true ){
//             proro.push(resultss[i])
...
//     resultss.name= searchInput.value

// })
// let searchApiUrl = async function getMoves(){
...
//   let searchMove = searchInput.value;
  
//   if(searchMove != '') {
//     getMovies(searchApiUrl+'&query='+searchMove);
//   }
